...
public class ParticipantAccepteParAdmin extends JPanel {

	private JTable table;
	/**
	 * Create the panel.
	 */
	public ParticipantAccepteParAdmin() {
		...
		try {
		    ...
		    List<ejb.entity.Participant> list=proxy.listeParticipantsAccepteParAdmin();
		...
		JLabel lblLesRsumsAccepts = new JLabel("Les r\u00E9sum\u00E9s accept\u00E9s par le responsable du congr\u00E8s");
		lblLesRsumsAccepts.setFont(new Font("MS Reference Sans Serif", Font.BOLD, 18));
		lblLesRsumsAccepts.setBounds(10, 0, 622, 42);
